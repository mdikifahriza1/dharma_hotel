<div class="sidebar">
    ...
    <ul class="nav-links">
        ...
        <li><a href="admin-profil.php"><i class="fas fa-user"></i> Profil</a></li>
        <li><a href="admin-about.php"><i class="fas fa-info-circle"></i> About</a></li>
        ...
        <li><a href="admin-ulasan.php"><i class="fas fa-star"></i> Ulasan</a></li>
